Congressional Redistricting Laws by State
Interactive visualization tool by Zach Levitt and Ethan Ackerman
Voting Rights Data Institute, 2018

This R Shiny App downloads a state boundary file from the R tigris package and merges it with state redistricting data from Google Sheets. 
